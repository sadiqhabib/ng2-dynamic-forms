...
import { DynamicFormNgBootstrapComponent, DYNAMIC_FORM_UI_NGBOOTSTRAP } from "./dynamic-form-ngbootstrap.component";
...
describe("DynamicFormNgBootstrapComponent test suite", () => {
    ...
    it("should initialize correctly", () => {
        ...
        expect(component.type).toEqual(DYNAMIC_FORM_UI_NGBOOTSTRAP);
